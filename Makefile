...
#ifdef VENDOR_EDIT
#guorui@HQ.BSP, 2020-09-28
ifeq ($(TARGET_BUILD_VARIANT), user)
KBUILD_CFLAGS   += -DOPPO_TARGET_BUILD_USER
KBUILD_CPPFLAGS += -DOPPO_TARGET_BUILD_USER
CFLAGS_KERNEL   += -DOPPO_TARGET_BUILD_USER
CFLAGS_MODULE   += -DOPPO_TARGET_BUILD_USER
endif
